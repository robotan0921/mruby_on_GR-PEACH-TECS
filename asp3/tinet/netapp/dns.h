 ...
 * 
 *  @(#) $Id: dns.h 968 2016-06-19 14:49:07Z coas-nagasima $
 */
...
typedef struct dns_hdr {
	...
	} __attribute__((packed))T_DNS_HDR;
...
typedef struct dns_soa {
	...
	} __attribute__((packed))T_DNS_SOA;
