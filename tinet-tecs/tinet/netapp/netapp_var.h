 ...
 * 
 *  @(#) $Id: netapp_var.h 936 2016-05-02 11:18:27Z coas-nagasima $
 */
...
extern char	*resolv_options (uint_t *flags, char *line);
extern char	*resolv_hoststr (uint_t *flags, char *hostname, uint_t name_size, char *line);
extern char	*lookup_ipaddr (T_IN_ADDR *addr, char *line);
