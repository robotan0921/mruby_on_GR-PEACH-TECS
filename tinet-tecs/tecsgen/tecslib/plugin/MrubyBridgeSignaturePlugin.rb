...
#   の責任を負わない．
#  
#   $Id: MrubyBridgeSignaturePlugin.rb 2640 2017-06-03 11:27:12Z okuma-top $
#
...
class MrubyBridgeSignaturePlugin < SignaturePlugin
  ...
  def initialize( signature, option )
    ...
    if ! @@b_no_banner
      STDERR << "MrubyBridgePlugin: version 1.2.1 (Suitable for mruby ver 1.2.0. Has backward compatibility with ver 1.1.0)\n"
      @@b_no_banner = true
    end
